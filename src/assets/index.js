...
export { default as greenIcon } from "./green-clock.png";
export { default as profileWhite } from "./Profile-white.png";
export { default as homeImage1 } from "./home-image3.png";
export { default as playStore } from "./play-store.png";
export { default as appleStore2 } from "./app-store.png";
export { default as comparison } from "./comparison.png";
export { default as wave } from "./wave.png";
export { default as mobileSS } from "./mobile-ss.png";
export { default as homeIcon1 } from "./icon1.png";
export { default as homeIcon2 } from "./icon2.png";
export { default as homeIcon3 } from "./icon3.png";
export { default as homeIcon4 } from "./icon4.png";
export { default as homeIcon5 } from "./icon5.png";
export { default as homeEllipse } from "./home-ellipse2.png";
export { default as androidQR } from "./andr-qr1.png";
export { default as appleQR } from "./apple-qr1.png";
export { default as aboutUsImg } from "./about-image1.png";
export { default as emoji1 } from "./emoji1.png";
export { default as emoji2 } from "./emoji2.png";
export { default as emoji3 } from "./emoji3.png";
export { default as aboutEllipse } from "./about-ellipse3.png";
export { default as kawan } from "./kawan.png";
export { default as listTag } from "./list-tag.png";
export { default as forArrow } from "./for-arrow.png";
export { default as preArrow } from "./pre-arrow.png";
export { default as aboutEllipse2 } from "./about-ellipse4.png";
